...
public class Odometer implements TimerListener {
	...
	public Odometer(TwoWheeledRobot robot, int period, boolean start) { //odometer does not need radii passed because it's encoded in TwoWheeledRobot
		// initialise variables
		this.robot = robot;
		//this.nav = new Navigation(this, leftRadius, rightRadius, width);
